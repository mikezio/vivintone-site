...
function App() {
  ...
  return <><a className="skip" href="#main">Skip to content</a><header className="nav"><a className="brand" href="#top">Vivint<span>One</span> / Hardware Lab</a><div><a href="#compatibility">Compatibility</a><a href="#offer">Offer hardware</a><a href="https://github.com/mikezio/vivintone-home-assistant">GitHub</a></div></header><main id="main">
